...
class TestSubtasks(InstructorTaskModuleTestCase):
    """Tests for subtasks."""
    ...
    def _enroll_students_in_course(self, course_id, num_students):
        ...
        for _ in range(num_students):
            ...
            student = UserFactory.create(username='student%s' % random_id, email='student%s@edx.org' % random_id)
            CourseEnrollmentFactory.create(course_id=course_id, user=student)
