...
class LocMapperSetupSansDjango():
    """
    ...
    def setUp(self):
        ...
        self.loc_store = LocMapperStore(self.instrumented_cache, **modulestore_options)
...
class TestLocationMapper(unittest.TestCase, LocMapperSetupSansDjango):
    """
